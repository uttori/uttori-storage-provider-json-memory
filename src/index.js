...
/**
  ...
  */
   ...
   * @returns {Promise} Promise object represents the returned history object.
   * @memberof StorageProvider
   */
  getHistory(slug) {
  ...
  add(document) {
    ...
    if (!existing) {
      ...
      this.updateHistory(document.slug, document);
  ...
  updateValid(document, originalSlug) {
    ...
    document.tags = R.isEmpty(document.tags) ? [] : document.tags;
    document.customData = R.isEmpty(document.customData) ? {} : document.customData;
    this.updateHistory(document.slug, document, originalSlug);
  ...
  delete(slug) {
    ...
    if (existing) {
      ...
      this.updateHistory(slug, existing);
 ...
 * @param {Document} content - The revision of the document to be saved.
 * @param {string} originalSlug - The original slug identifying the document, or the slug if it has not changed.
 * @memberof StorageProvider
 */
